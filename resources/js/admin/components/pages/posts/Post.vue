                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group input-group-sm">
                            ...
                            <input type="text" class="form-control" placeholder="Tên bài viết" v-model="query.name">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group input-group-sm">
                            ...
                            <div class="card-body data-table table-responsive p-0">
                                <table class="table text-center table-hover table-head-fixed text-nowrap">
                                    <thead>
                                        <tr>
                                            <th style="width: 25px">
                                                <a href="/" @click="sortPostData($event, 'id_sort')">
                                                    ID
                                                    <i
                                                        class="id-icon fas"
                                                        v-bind:class="[
    ...
    export default {
        ...
        methods: {
            ...
            async deleteData(e, id) {
                ...
                var alertMessage = 'Bạn muốn xóa bài viết này?';
                var successMessage = 'Xóa thành công';
                if (this.query.is_deleted == 1) {
                    alertMessage = 'Bạn muốn khôi phục bài viết này?';
