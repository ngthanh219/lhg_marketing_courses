<template>
    <div class="wrapper">
        ...
        <div class="reason">
            <div class="reason-container page">
                ...
                <div class="reason-box">
                    <div class="rb-item">
                        <div class="image">
                            <img :src="$env.s3Url + 'banners/banner2.png/rs1.png'" alt="">
                        </div>
                    ...
                    <div class="rb-item">
                        <div class="image">
                            <img :src="$env.s3Url + 'banners/banner2.png/rs2.png'" alt="">
                        </div>
                        <p>Chất lượng</p>
                    ...
                    <div class="rb-item">
                        <div class="image">
                            <img :src="$env.s3Url + 'banners/banner2.png/rs3.png'" alt="">
                        </div>
        ...
        <div class="reason">
            <div class="reason-container page">
                <h3>Học viên nói về chúng tôi?</h3>
                <div class="reason-box">
                    <div class="rb-item">
                        <div class="image">
                            <img src="https://edubit.vn/views/themes/default/img/hv1.jpg" alt="">
                        </div>
                        <p>Trần Thị Ngọc Hoa</p>
                        <span>
                            “Thầy dạy rất dễ hiểu áp dụng được ngay vào công việc kinh doanh ...!!! Rất tận tâm và lấy ví dụ hàng ngày vào bài giảng ...!!!”
                        </span>
                    </div>
                    <div class="rb-item">
                        <div class="image">
...
<script>
    import FirstBanner from '../commons/banner/FirstBanner.vue';
    import SecondBanner from '../commons/banner/SecondBanner.vue';
